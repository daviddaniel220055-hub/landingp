  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-[#202027]">
      ...
      <section className="relative overflow-hidden bg-white px-6 pb-8 pt-3 md:pb-12 md:pt-6">
        ...
        {/* Background blobs */}
        <motion.div
          className="absolute -left-20 -top-24 h-34 w-64 rounded-full bg-purple-100/70 blur-3xl"
          animate={{
            x: [0, 25, 0],
            y: [0, 20, 0],
          }}
        ...
        <motion.div
          className="absolute -right-20 -top-16 h-34 w-64 rounded-full bg-purple-100/70 blur-3xl"
          animate={{
            x: [0, -25, 0],
            y: [0, 15, 0],
          }}
