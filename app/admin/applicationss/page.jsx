...
const API_BASE_URL =
  "https://toshconsultblogfastapi.onrender.com";
...
export default function ApplicationNotificationPage() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      router.replace("/admin?redirect=/admin/application");
      return;
    }
    ...
    try {
      ...
      for (const job of jobsList) {
        ...
        try {
          ...
          console.log(
            `APPLICATION STATUS FOR JOB ${jobId}:`,
            applicationsResponse.status
          );

          console.log(
            `APPLICATION RESPONSE FOR JOB ${jobId}:`,
            applicationsData
          );
          ...
          if (
            ...
            router.replace(
              "/admin?redirect=/admin/application"
            );
